...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.lch.ccims.demo.common.annotation.RedisCache)") // 表示匹配@RedisCache 注解的切入点
    ...
    public Object around(ProceedingJoinPoint joinPoint){
        ...
        Object obj = null; //redisCache.getDataFromRedis(redisKey);
        ...
        String code = "OK"; //redisCache.saveDataToRedis(redisKey,obj);
        if("OK".equals(code)){
